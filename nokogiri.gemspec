# -*- encoding: utf-8 -*-
# stub: nokogiri 1.11.0.rc3.20200927222123 ruby lib
# stub: ext/nokogiri/extconf.rb

Gem::Specification.new do |s|
  s.name = "nokogiri".freeze
  s.version = "1.11.0.rc3.20200927222123"
  ...
  s.extra_rdoc_files = ["LICENSE-DEPENDENCIES.md".freeze, "LICENSE.md".freeze, "README.md".freeze]
